              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="mb-3 form-floating">
                        <input type="text" name="project_id" id="projectId" class="form-control"
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <div class="row">
                              <div class="col-12">
                                <div class="mb-3 form-floating">
                                  <input type="text" name="issue_no" id="updateIssueNo" class="form-control"
                                    placeholder="Issue No" value="{{ $row->issue_no }}">
                              ...
                              <div class="col-12">
                                <div class="mb-3 form-floating">
                                  <input type="text" name="reference" id="updateReference" class="form-control"
                                    placeholder="Reference" value="{{ $row->reference }}">
                              ...
                              <div class="col-12">
                                <div class="mb-3 form-floating">
                                  <input type="text" name="project_id" id="updateProjectId" class="form-control"
                                    placeholder="Project ID" value="{{ $row->project_id }}">
                ...
                <div class="d-inline-block">
                  <button type="button" class="btn btn-danger" data-bs-target="#deleteModal-{{ $row->id }}"
